document.addEventListener('DOMContentLoaded', () => {
    ...
    // Si aucune donnée n'est trouvée, initialise à un objet vide pour éviter les erreurs.
    ...
    // Si aucune donnée n'est trouvée, initialise à 0 pour éviter les erreurs.
    ...
    console.log("Date et heure exactes :", formattedDateWithSeconds); // Affiche la date complète avec secondes pour vérification
    ...
    // Deuxième vérification : Si la date (avec secondes) a changé mais que la date sans secondes est la même.
        ...
        const previousHabits = habitHistory[lastCalculatedDate] || 0; // Obtenir les habitudes précédentes pour comparaison
        const newMoney = completedHabitsToday - previousHabits; // Calculer la différence pour savoir combien d'habitudes supplémentaires ont été complétées
